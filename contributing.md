...
```bash
git clone https://github.com/<username>/plop-generator-remix-route
```

Next you need to install the dependencies.

```bash
cd plop-generator-remix-route
npm install
```
...
[license]: https://github.com/bradgarropy/plop-generator-remix-route/blob/master/license
[fork]: https://github.com/bradgarropy/plop-generator-remix-route/fork
[contributors]: https://github.com/bradgarropy/plop-generator-remix-route#-contributors
